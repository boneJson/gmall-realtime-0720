...
import com.zxk.gmall.realtime.bean.TradeProvinceOrderWindow;
...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        ...
        SingleOutputStreamOperator<TradeProvinceOrderWindow> reduceDS = keyedStream.window(TumblingEventTimeWindows.of(Time.seconds(10)))
        ...
        //TODO 6.关联维表获取省份名称
        SingleOutputStreamOperator<TradeProvinceOrderWindow> tradeProvinceWithProvinceNameDS = AsyncDataStream.unorderedWait(reduceDS, new DimAsyncFunction<TradeProvinceOrderWindow>("DIM_BASE_PROVINCE") {
            @Override
