...
//TODO 5.过滤出订单明细活动数据
        ...
        Table orderCouponTable = tableEnv.sqlQuery("" +
                ...
                "and `type`='insert'");
        tableEnv.createTemporaryView("order_coupon", orderCouponTable);//打印测试
        ...
        //注意两个时间戳字段的类型和old字段的map类型,以及upsert-kafka的sinktable必有的主键字段
        tableEnv.executeSql("" +
